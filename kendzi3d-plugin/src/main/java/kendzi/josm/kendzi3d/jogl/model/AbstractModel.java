...
public abstract class AbstractModel extends AbstractWorldObject
    ...
    protected AbstractModel(Perspective perspective) {
        this.perspective = perspective;
        setPoint(new Vector3d());
    }

    @Deprecated
    protected AbstractModel(Way way, Perspective perspective) {
        this.perspective = perspective;
        setPoint(new Vector3d());
     ...
     */
    @Override
    public Vector2dc toModelFrame(Node pNode) {
        Vector2d calcPoint = new Vector2d(perspective.calcPoint(pNode));
