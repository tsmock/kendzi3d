...
public class RoofType2v1 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double recHeight, double recWidth,
        ...
        Vector3d planeLeftPoint = new Vector3d(leftMiddlePoint.x(), roofHeightBottom, -leftMiddlePoint.y());
        Vector3d planeRightPoint_ZZZ = new Vector3d(rightMiddlePoint.x(), roofHeightTop, -rightMiddlePoint.y());
