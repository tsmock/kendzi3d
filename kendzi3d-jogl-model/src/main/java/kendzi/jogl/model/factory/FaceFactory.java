...
public class FaceFactory {
    ...
    private void validateAddedTextureCoordinates(int numOfAddedTexturesCoordinates) {
        if (this.coordIndexLayers.size() != numOfAddedTexturesCoordinates) {
            throw new RuntimeException("face have setup: " + this.coordIndexLayers.size()
                    + " textures layers but added vertex has only coordinate for: " + numOfAddedTexturesCoordinates);
        }
    }
