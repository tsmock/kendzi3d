...
public class RoofType2v5 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double recHeight, double recWidth,
        ...
        Vector2d middlePoint = new Vector2d(b1, b2);
        Vector2d plb = new Vector2d(0, 0);
        Vector2d plt = new Vector2d(0, recHeight);
        Vector2d prb = new Vector2d(recWidth, 0);
        Vector2d prt = new Vector2d(recWidth, recHeight);
        ...
        Vector3d nl = new Vector3d(-h1, b1, 0).normalize();
        Vector3d nr = new Vector3d(h1, recWidth - b1, 0).normalize();

        Vector3d nt = new Vector3d(0, recHeight - b2, -h1).normalize();
        Vector3d nb = new Vector3d(0, b2, h1).normalize();

        Vector3d planePoint = new Vector3d(middlePoint.x, h1, -middlePoint.y);
