...
public class RoofLinesBuildier {
    ...
    public static RoofOutput build(BuildingPart bp, double maxHeight, ModelFactory mf, TextureData roofTextureData,
        ...
        for (Triangle2d triangle : triangles) {
            ...
            Vector3d pp1 = new Vector3d(p1.x(), h1, -p1.y());
            Vector3d pp2 = new Vector3d(p2.x(), h2, -p2.y());
            Vector3d pp3 = new Vector3d(p3.x(), h3, -p3.y());

            Vector3d n = pp1.sub(pp2, new Vector3d());
            n.cross(pp1.sub(pp3, new Vector3d()));
