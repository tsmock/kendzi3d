...
public class RoofType2v7 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double recHeight, double recWidth,
        ...
        Vector2d rightTopPoint = new Vector2d(recWidth - l1, recHeight);
        Vector2d rightBottomPoint = new Vector2d(recWidth, 0);

        Vector2d leftTopPoint = new Vector2d(l2, recHeight);
        ...
        Vector3d nl = new Vector3d(-h1, l2, 0).normalize();
        Vector3d nr = new Vector3d(h1, l1, 0).normalize();
        Vector3d nb = new Vector3d(0, recHeight, h1).normalize();
        ...
        Vector3d planeLeftPoint = new Vector3d(leftTopPoint.x(), h1, -leftTopPoint.y());

        Vector3d planeRightPoint = new Vector3d(rightTopPoint.x(), h1, -rightTopPoint.y());
