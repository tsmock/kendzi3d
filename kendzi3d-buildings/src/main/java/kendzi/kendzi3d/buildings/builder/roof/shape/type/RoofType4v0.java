...
public class RoofType4v0 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double pRecHeight, double pRecWidth,
            Vector2dc[] pRectangleContur, double h1, double h2, double l2, RoofMaterials roofTextureData) {
        ...
        Vector2d rightTopPoint = new Vector2d(pRecWidth, pRecHeight - l2);
        Vector2d rightMiddlePoint = new Vector2d(pRecWidth, 0.5d * pRecHeight);
        Vector2d rightBottomPoint = new Vector2d(pRecWidth, l2);

        Vector2d leftTopPoint = new Vector2d(0, pRecHeight - l2);
        Vector2d leftMiddlePoint = new Vector2d(0, 0.5d * pRecHeight);
        Vector2d leftBottomPoint = new Vector2d(0, l2);
        ...
        Vector3d nmt = new Vector3d(0, pRecHeight * 0.5d - l2, -(h1 - h2)).normalize();

        Vector3d nmb = new Vector3d(0, pRecHeight * 0.5d - l2, h1 - h2).normalize();
        ...
        Vector3d planeLeftBottomPoint = new Vector3d(leftBottomPoint.x, h2, -leftBottomPoint.y);

        Vector3d planeRightTopPoint = new Vector3d(rightTopPoint.x, h2, -rightTopPoint.y);
        ...
        HeightCalculator hc = new MultiSplitHeightCalculator() {
            ...
            public double calcHeight(Vector2dc point) {
                return RoofType4v0.calcHeight(point, middleLine, bottomLine, topLine, planeTop, planeMiddleTop, planeMiddleBottom,
                        planeBottom);
            }
