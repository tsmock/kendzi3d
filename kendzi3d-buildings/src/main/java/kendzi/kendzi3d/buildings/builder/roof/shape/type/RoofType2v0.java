...
public class RoofType2v0 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double recHeight, double recWidth,
            Vector2dc[] rectangleContur, double roofHeight, double l1, RoofMaterials roofTextureData) {
        ...
        Vector2d leftMiddlePoint = new Vector2d(0, l1);
        Vector2d rightMiddlePoint = new Vector2d(recWidth, l1);

        final LinePoints2d middleRoofLine = new LinePoints2d(leftMiddlePoint, rightMiddlePoint);

        Vector3d normalTop = new Vector3d(0, l1, -roofHeight).normalize();
        ...
        Vector3d planeLeftPoint = new Vector3d(leftMiddlePoint.x, roofHeight, -leftMiddlePoint.y);
        Vector3d planeRightPoint = new Vector3d(rightMiddlePoint.x, roofHeight, -rightMiddlePoint.y);
