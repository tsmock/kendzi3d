...
/**
 * Describe how to translate coordinates from EastNorth perspective to openGl
 * perspective.
 * 
 * Center coordinates are used because of openGl numerical errors in large
 * distances from point (0,0) It is possible that I do something wrong and they
 * are not needed.
 * 
...
public class Perspective3D implements Perspective {
     ...
     */
    @Override
    public Vector2dc calcPoint(Node node) {
        EastNorth eastNorth = node.getEastNorth();
        return calcPoint(eastNorth);
    }

    public Vector2dc calcPoint(EastNorth eastNorth) {
