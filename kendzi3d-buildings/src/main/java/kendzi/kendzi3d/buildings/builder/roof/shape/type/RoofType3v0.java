...
public class RoofType3v0 extends RectangleRoofTypeBuilder {
    ...
    protected RoofTypeOutput build(PolygonWithHolesList2d buildingPolygon, double pRecHeight, double pRecWidth,
        ...
        Vector2d rightMiddlePoint = new Vector2d(pRecWidth, l1);

        Vector2d leftMiddlePoint = new Vector2d(0, l1);

        final LinePoints2d mLine = new LinePoints2d(leftMiddlePoint, rightMiddlePoint);

        Vector3d nt = new Vector3d(0, pRecHeight - l1, -h2).normalize();

        Vector3d nb = new Vector3d(0, l1, h1).normalize();
        ...
        Vector3d planeLeftPoint = new Vector3d(leftMiddlePoint.x, height, -leftMiddlePoint.y);

        Vector3d planeRightPoint = new Vector3d(rightMiddlePoint.x, height, -rightMiddlePoint.y);
